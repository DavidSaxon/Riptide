 ...
 */
#ifndef RIPTIDE_COMMON_BASE_GLOBAL_HPP_
#define RIPTIDE_COMMON_BASE_GLOBAL_HPP_
...
/*!
 * \brief The path to the Riptide common metadata directory.
 */
extern const arc::io::sys::Path META_COMMON_DIR;
