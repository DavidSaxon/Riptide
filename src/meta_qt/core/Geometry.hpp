...
/*!
 * \brief Shorthand for meta_qt::WidgetSize::instance
 */
#define MQT_WGTSZV meta_qt::WidgetSize::instance

/*!
* \brief Shorthand for meta_qt::WidgetPosition::instance
*/
#define MQT_WGTPOSV meta_qt::WidgetPosition::instance
